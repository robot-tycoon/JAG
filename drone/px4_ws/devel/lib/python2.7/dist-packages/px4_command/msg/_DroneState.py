...
"""autogenerated by genpy from px4_command/DroneState.msg. Do not edit."""
import sys
...
class DroneState(genpy.Message):
  _md5sum = "aef04f956ed2d9034fe86b14ca95f171"
  _type = "px4_command/DroneState"
...
float64 w
"""
  __slots__ = ['header','connected','armed','mode','time_from_start','position','velocity','attitude','attitude_q','attitude_rate']
  _slot_types = ['std_msgs/Header','bool','bool','string','float32','float32[3]','float32[3]','float32[3]','geometry_msgs/Quaternion','float32[3]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,connected,armed,mode,time_from_start,position,velocity,attitude,attitude_q,attitude_rate
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_f().pack(self.time_from_start))
